/*
SQL Script for CP3561 Assignment 1

Note: Remove Drop Table commands for first time running the script.

Confirm tables are created by the select statments at the end.
